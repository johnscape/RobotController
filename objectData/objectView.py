...
class Face:
    ...
    def DistanceFromVerticle(self, other: Verticle):
        d1 = VerticleDistance(self.Verticle1, other)
        d2 = VerticleDistance(self.Verticle2, other)
        d3 = VerticleDistance(self.Verticle3, other)
